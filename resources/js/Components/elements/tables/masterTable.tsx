...
export default function MasterTable({
    ...
    const [tabParam, setTabParam, tabParamRef] = useStateRef(filters.currentTab ?? "");
    ...
    function revisitPage() {
        ...
        router.get(
            url,
            {
                ...
                currentTab: tabParamRef.current,
            },
            {
                replace: true,
                preserveState: true,
    ...
    return (
        <>
           {filterTabs?.length>0&&<div className="flex flex-wrap items-center justify-start gap-2 sm:gap-4 mb-6 border-b overflow-x-auto px-2">
            ...
            <div className="md:flex md:items-center md:justify-between">
                <div className="min-w-0 flex-1">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="w-full md:w-2/6 flex self-center">
                            {search && (
                                <SearchInput
                                    id="search"
