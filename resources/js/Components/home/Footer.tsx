    ...
    return (
        <footer className="bg-gray-100 text-sm text-black py-7 relative ">
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-4">
                <div>
                    {/* <img src="" alt="TastyTalks Logo" className="h-20 w-auto " /> */}
                    <Link href={"/"} ><h1 className="text-2xl font-bold text-green-600">TastyTalks</h1></Link>
                    <p className="mt-4 mr-8 sm:mt-7 max-w-xs">Join now to receive personalized recommendations from the full TastyTalks</p>
            ...
            <div className="container mx-auto">
                <div
                    ...
                    <div className="container mt-4 mb-8 mx-auto text-center md:text-left flex justify-center items-center">
                        <p>© {year} TastyTAlks. All rights reserved. Developed And Maintained By <a href="https://www.axcertro.com" target="_blank" rel="noopener noreferrer" className="text-decoration: underline">TastTalks Team</a></p>
                    </div>
                </div>
            </div>
        </footer>
